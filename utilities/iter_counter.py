...
class IterationCounter():
    def __init__(self, opt, dataset_size):
        ...
        self.iter_record_path = os.path.join(self.opt.checkpoints_dir, 'iter.txt')
    ...
    def record_one_iteration(self):
        ...
        # so we can assume batch size is always self.batchSize
    ...
    def needs_displaying(self):
        return (self.total_steps_so_far % self.opt.display_freq) < self.batchSize